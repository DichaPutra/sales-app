                                ...
                                <table class="table table-striped" id="example" class="display responsive nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>PT. Surabaya Mekabox</td>
                                            <td><div class="toolbox">
                                                <center><a href="editcustomer" style="color: blue;font-size:20px"><i class="mdi mdi-pencil"></i></a>
                                                    &emsp;&emsp;
                                                    <a style="color: #cc0000;font-size:20px"><i class="mdi mdi-delete" data-toggle="modal" data-target="#hapusModal"></i></a></center>
                                                </div></td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah anda yakin menghapus customer ini ?</p>
                                                        </div>
                                                        <!-- footer modal -->
