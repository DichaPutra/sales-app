                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><div class="toolbox">
                                                <center><a style="color: blue;font-size:20px"><i class="mdi mdi-pencil" data-toggle="modal" data-target="#editUser"></i></a>
                                                    &emsp;&emsp;
                                                    <a style="color: #cc0000;font-size:20px"><i class="mdi mdi-delete" data-toggle="modal" data-target="#hapusUser"></i></a></center>
                                                </div></td>
                                            </tr>
                                            <!-- Modal Edit Status-->
                                        ...
                                        <!-- Modal Hapus User -->
                                        <div id="hapusUser" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- konten modal-->
                                                <div class="modal-content">
                                                    <!-- heading modal -->
