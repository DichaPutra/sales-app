...
class KunjunganAdminController extends Controller {
    ...
    public function index(Request $request)
    {
        ...
        //get all nama perusahaan
        $customer = customer::select('id', 'nama_perusahaan')->get();
    ...
    public function updateKunjungan(Request $request)
    {
        ...
        $kunjungan->nama_perusahaan = $request->customer;
        $kunjungan->nama_pic = $request->namapic;
        $kunjungan->contact_no_pic = $request->kontakpic;
        $kunjungan->produk = $request->produk;
        $kunjungan->harga = $request->kisaranharga;
        $kunjungan->waktu_pembelian = $request->waktu;
        $kunjungan->lainlain = $request->lainlain;
        $kunjungan->save();
